...
import type { DemoCustomerRecord, DemoVehicleForm, DemoVehicleRecord } from '@/types/demo';

const demoCustomers: DemoCustomerRecord[] = [
  { id: 'cust_demo_1', fullName: 'John Doe' },
  { id: 'cust_demo_2', fullName: 'Sarah Lee' },
];

const demoVehicles: DemoVehicleRecord[] = [
  {
    id: 'veh_demo_1',
...
const initialForm: DemoVehicleForm = {
...
export function VehiclesPanel() {
  const [vehicles, setVehicles] = useState<DemoVehicleRecord[]>(demoVehicles);
  const [search, setSearch] = useState('');
  const [form, setForm] = useState<DemoVehicleForm>(initialForm);
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const vehicle: DemoVehicleRecord = {
  ...
  function customerNameFor(vehicle: DemoVehicleRecord) {
    return (
